...
export const WebPreview = ({
  ...
  return (
    <WebPreviewContext.Provider value={contextValue}>
      <div
        className={cn(
          "flex size-full flex-col overflow-hidden bg-zinc-950",
          className
        )}
        {...props}
      >
...
export const WebPreviewNavigation = ({
  ...
  <div
    className={cn("flex items-center gap-1 border-b border-zinc-800 bg-zinc-900/60 px-2 py-1.5", className)}
    {...props}
  >
    {children}
  </div>
...
export const WebPreviewUrl = ({
  ...
  return (
    <Input
      className="h-6 flex-1 border-zinc-700 bg-zinc-900 text-[11px] text-zinc-400"
